...
router.get('/teacher/:teacherId/reporting', authMiddleware, checkRole(['administrator', 'nauczyciel']), SubstituteController.getByTeacherReporting);
router.get('/teacher/:teacherId/substituting', authMiddleware, checkRole(['administrator', 'nauczyciel']), SubstituteController.getByTeacherSubstituting);
