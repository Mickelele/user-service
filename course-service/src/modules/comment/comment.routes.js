...
router.get('/student/:id_ucznia', authMiddleware, checkRole(['uczen', 'opiekun', 'nauczyciel']), checkGuardianStudent('id_ucznia'), checkTeacherStudent('id_ucznia'), UwagaController.getByStudentId);
