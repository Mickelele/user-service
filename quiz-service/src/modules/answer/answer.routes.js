...
router.get('/pytanie/:questionId', authMiddleware, checkRole(['administrator', 'uczen', 'nauczyciel']), AnswerController.getByQuestion);
router.get('/:id', authMiddleware, checkRole(['administrator', 'nauczyciel']), AnswerController.getOne);
