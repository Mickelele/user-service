...
router.get('/historia/user/:userId', authMiddleware, StatusController.getHistoriaStatusowByUserId);
router.get('/current/user/:userId', authMiddleware, StatusController.getCurrentStatusByUserId);
